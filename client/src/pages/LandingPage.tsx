      ...
      <section className="px-6 max-w-2xl mx-auto mb-16">
        ...
        <div className="flex flex-col gap-4">
          {[
            ...
            { icon: '📊', title: '근태 리포트 (지각·조퇴·결근)', desc: '요일별 근무 스케줄을 기준으로 지각·조퇴·결근·퇴근누락을 월간 자동 집계.' },
            { icon: '📄', title: '급여 명세서 출력', desc: '월별 근태 내역과 급여를 PDF/CSV로 출력해서 직원에게 전달.' },
            { icon: '🏢', title: '부서별 그룹 관리', desc: '홀·주방 등 부서로 나눠 키오스크에서 본인을 빠르게 선택. (엔터프라이즈)' },
            { icon: '📋', title: '직원 CSV 일괄 등록', desc: '직원 명단을 CSV로 한 번에 등록. 대규모 사업장 온보딩에 적합. (엔터프라이즈)' },
